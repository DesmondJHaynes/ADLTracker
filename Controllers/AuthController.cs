...
public class AuthController : ControllerBase
{
    ...
    public AuthController(ADLTrackerDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
    ...
    public IActionResult Me()
    {
        ...
        var profile = _dbContext.Providers.SingleOrDefault(up => up.IdentityUserId == identityUserId);
